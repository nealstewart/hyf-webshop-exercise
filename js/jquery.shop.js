(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "HYG-"; // Prefix string to be prepended to the cart's name in the local storage
			this.cartName = this.cartPrefix + "cart"; // Cart name in the local storage
			this.shippingRates = this.cartPrefix + "shipping-rates"; // Shipping rates key in the local storage
			this.total = this.cartPrefix + "total"; // Total key in the local storage
		...
		// Creates the cart keys in the local storage
		...
		// Handles the checkout form by adding a validation routine and saving user's info into the local storage
		...
		handleCheckoutOrderForm: function() {
			...
			if( self.$checkoutOrderForm.length ) {
				...
				self.$checkoutOrderForm.on( "submit", function(e) {
					e.preventDefault();
					var $form = $( this );
